            ...
            <div className="flex items-center justify-center ">
                <div className="relative flex-shrink-0 max-w-xs mx-2  mb-6  overflow-hidden bg-yellow-500 rounded-lg shadow-lg">
                    ...
                    <div className="relative flex items-center justify-center px-10 pt-10">
                        ...
                        <picture>
                            <img className="relative w-40" src="https://www.brcline.com/wp-content/uploads/2020/06/javascript-logo.png" alt="shopping item" />
                        </picture>
                    </div>
                    <div className="relative px-6 pb-6 my-2 text-white">
                ...
                <div className="relative flex-shrink-0 max-w-xs mx-2 my-2 mb-6  overflow-hidden bg-blue-500 rounded-lg shadow-lg">
                    <svg className="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none">
                    ...
                    <div className="relative flex items-center justify-center px-10 pt-10">
                        ...
                        <img className="relative w-40" src="https://www.brcline.com/wp-content/uploads/2020/06/javascript-logo.png" alt="shopping" />
                    </div>
                ...
                <div className="relative flex-shrink-0 max-w-xs mx-2 my-2 mb-6  overflow-hidden bg-purple-500 rounded-lg shadow-lg">
                    <svg className="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none">
